...
def main(capture_images=False):
    ...
    try:
        ...
        while True:
            ...
            longitude, latitude, satellites = gps_func.get_gps()  #Remember that it will return 0, 0 if not gps fix is established
            ...
            time.sleep(1)  #Adjust this to decide how often to capture images.
